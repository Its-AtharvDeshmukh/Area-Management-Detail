...
exports.postLogin = async (req, res) => {
    try {
        ...
        // 1. Check if it is the Super Admin (Case-insensitive check)
        ...
        // 2. Check if it is an Authorized User (Case-insensitive check)
...
exports.postRegister = async (req, res) => {
    try {
        ...
        // Case-insensitive check across both User and Admin collections to prevent duplicates
